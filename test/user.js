...
describe('delete follow record', () => {
  it('it should be able delete follow record', async () => {
    try {
      const result = await followingModel.unfollow(1, 1);
...
describe('follow the user who does not exist', () => {
  it('should return bad request', (done) => {
    chai.request(app).post('/api/profiles/mimi/follow').set('Authorization', `Bearer ${newtoken}`)
      .then((res) => {
        res.should.have.status(400);
...
describe('user should not follow himself', () => {
  it('should return conflict', (done) => {
    chai.request(app).post(`/api/profiles/${user.username}/follow`).set('Authorization', `Bearer ${newtoken}`)
      .then((res) => {
...
describe('user should follow another', () => {
  it('should follow other', (done) => {
    chai.request(app).post(`/api/profiles/${ruser.username}/follow`).set('Authorization', `Bearer ${newtoken}`)
      .then((res) => {
...
describe('user should unfollow another', () => {
  it('should unfollow other', (done) => {
    chai.request(app).delete(`/api/profiles/${ruser.username}/follow`).set('Authorization', `Bearer ${newtoken}`)
      .then((res) => {
        res.should.have.status(201);
        res.should.be.a('object');
        done();
...
describe('user should not unfollow himself', () => {
  it('should return conflict', (done) => {
    chai.request(app).delete(`/api/profiles/${user.username}/follow`).set('Authorization', `Bearer ${newtoken}`)
      .then((res) => {
        res.should.have.status(409);
        res.should.be.a('object');
        done();
...
describe('unfollow the user who does not exist', () => {
  it('should return bad request', (done) => {
    chai.request(app).delete('/api/profiles/joromi/follow').set('Authorization', `Bearer ${newtoken}`)
      .then((res) => {
        res.should.have.status(400);
        res.should.be.a('object');
        done();
